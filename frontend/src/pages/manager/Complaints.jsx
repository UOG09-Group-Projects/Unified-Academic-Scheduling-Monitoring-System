...
export default function ManagerComplaints() {
  ...
  // Live refresh so newly submitted parent concerns show up without a
  // manual reload. Paused while a modal is open so an in-progress reply
  // isn't yanked out from under the manager.
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <PageHeader title="Complaints & Help" subtitle="Concerns and help requests from parents at your institution" />
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-ink-faint truncate">
                        ...
                        {m.student && ` · Concerning ${m.student.name}`}
                      </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-xs text-ink-faint">
                ...
                {selected.student && ` · Concerning ${selected.student.name}`}
              </span>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Write a response to this parent…"
                rows={5}
